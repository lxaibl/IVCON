...
// Purpose:
//   Metthods for support of SoftImage hierarchy files
...
*/
{
    ...
    if ( strcasecmp( rd.word, "position" ) == 0 )
    {
...
/******************************************************************************/
{
    ...
    if ( strcasecmp( rd.word, "vertices" ) == 0 )
    {
...
/******************************************************************************/
{
    ...
    if ( strcasecmp( rd.word, "ambient" ) == 0 )
    {
        vec3 vt;
        width = hrc_read_vec3(rd.next,&vt);
        if ( width <= 0 )
    ...
    if ( strcasecmp( rd.word, "diffuse" ) == 0 )
    {
        width = hrc_read_vec3(rd.next,&vt);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "exponent" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "reflectivity" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "refracindex" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "specular" ) == 0 )
    {
        width = hrc_read_vec3(rd.next,&vt);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "transparency" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
...
/******************************************************************************/
{
    ...
    if ( strcasecmp( rd.word, "discontinuity" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "edges" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "flag" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "polygons" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "vertices" ) == 0 )
...
/******************************************************************************/
{
    ...
    if ( strcasecmp( rd.word, "material" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "texture" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "mesh" ) == 0 )
    {
        rd.vertex_num_old = vertex_num;
        return false;
    } else
    ...
    if ( strcasecmp( rd.word, "patch" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "rotation" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "scaling" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "spline" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "translation" ) == 0 )
    {
        return false;
    } else
    {
...
/******************************************************************************/
{
    ...
    if ( strcasecmp( rd.word, "normal" ) == 0 )
    {
    ...
    if ( strcasecmp( rd.word, "uvTexture" ) == 0 )
    {
        long ivert=face[rd.face_idx].order;
    ...
    if ( strcasecmp( rd.word, "vertex" ) == 0 )
    {
        long ivert=face[rd.face_idx].order;
        count = sscanf ( rd.next, "%d%n", &jval, &width );
        rd.next += width;
    ...
    if ( strcasecmp( rd.word, "vertexColor" ) == 0 )
    {
        long ivert=face[rd.face_idx].order;
        int ca,cr,cg,cb;
...
/******************************************************************************/
{
    ...
    if ( strcasecmp( rd.word, "approx_type" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "controlpoints" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "curv_u" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "curv_v" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "recmin" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "recmax" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "recursion" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "spacial" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "taggedpoints" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "ucurve" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "ustep" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "utension" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "utype" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "vclose" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "vcurve" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "viewdep" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "vpoint" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "vstep" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "vtension" ) == 0 ) {
    } else
    if ( strcasecmp( rd.word, "vtype" ) == 0 ) {
    } else
    {
        stats.bad_num++;
...
/******************************************************************************/
{
    ...
    if ( strcasecmp( rd.word, "nbKeys" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "step" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "tension" ) == 0 )
    {
        return false;
    } else
    if ( strcasecmp( rd.word, "type" ) == 0 )
...
/******************************************************************************/
{
    ...
    if ( strcasecmp( rd.word, "tagged" ) == 0 )
    {
    } else
    {
        stats.bad_num++;
...
/******************************************************************************/
{
    ...
    if ( strcasecmp( rd.word, "blending" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "effect" ) == 0 )
    {
        width = hrc_read_strword(rd.next,word2);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "glbname" ) == 0 )
    {
        width = hrc_read_strword(rd.next,word2);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "method" ) == 0 )
    {
        width = hrc_read_strword(rd.next,word2);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "offset" ) == 0 )
    {
        width = hrc_read_vec2(rd.next,&vd);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "pixelinterp" ) == 0 )
    {
    } else
    if ( strcasecmp( rd.word, "reflect" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "reflmap" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "repeat" ) == 0 )
    {
    } else
    if ( strcasecmp( rd.word, "rotation" ) == 0 )
    {
    ...
    if ( strcasecmp( rd.word, "roughness" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "transp" ) == 0 )
    {
        width = hrc_read_float(rd.next,&t);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "txtsup_rot" ) == 0 )
    {
        width = hrc_read_vec3(rd.next,&vt);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "txtsup_scal" ) == 0 )
    {
        width = hrc_read_vec3(rd.next,&vt);
        if ( width <= 0 )
            return false;
    ...
    if ( strcasecmp( rd.word, "txtsup_trans" ) == 0 )
    {
        width = hrc_read_vec3(rd.next,&vt);
        if ( width <= 0 )
            return false;
...
*/
{
	...
	for ( ;; )
    {
		...
		for ( ;; )
        {
			...
			// CONTROLPOINTS
			if ( strcasecmp( rd.llevel[rd.level].name, "controlpoints" ) == 0 )
            {
                if (!hrc_read_controlpoints_property(rd))
                    break;
			} else
			// EDGES
			if ( strcasecmp( rd.llevel[rd.level].name, "edges" ) == 0 )
            {
                if (!hrc_read_edges_property(rd))
                    break;
			} else
			// MATERIAL
			if ( strcasecmp( rd.llevel[rd.level].name, "material" ) == 0 )
            {
                if (!hrc_read_material_property(rd))
                    break;
			} else
			// MESH
			if ( strcasecmp( rd.llevel[rd.level].name, "mesh" ) == 0 )
            {
                if (!hrc_read_mesh_property(rd))
                    break;
			} else
			// MODEL
			if ( strcasecmp( rd.llevel[rd.level].name, "model" ) == 0 )
            {
                if (!hrc_read_model_property(rd))
                    break;
			} else
			// NODES
			if ( strcasecmp( rd.llevel[rd.level].name, "nodes" ) == 0 )
            {
                if (!hrc_read_nodes_property(rd))
                    break;
			} else
			// PATCH
			if ( strcasecmp( rd.llevel[rd.level].name, "patch" ) == 0 )
            {
                if (!hrc_read_patch_property(rd))
                    break;
			} else
			// POLYGONS
			if ( strcasecmp( rd.llevel[rd.level].name, "polygons" ) == 0 )
            {
                if (!hrc_read_polygons_property(rd))
                    break;
			} else
			// SPLINE
			if ( strcasecmp( rd.llevel[rd.level].name, "spline" ) == 0 )
            {
                if (!hrc_read_spline_property(rd))
                    break;
			} else
			// TAGGEDPOINTS
			if ( strcasecmp( rd.llevel[rd.level].name, "taggedpoints" ) == 0 )
            {
                if (!hrc_read_taggedpoints_property(rd))
                    break;
			} else
			// TEXTURE
			if ( strcasecmp( rd.llevel[rd.level].name, "texture" ) == 0 )
            {
                if (!hrc_read_texture_property(rd))
                    break;
			} else
			// VERTICES
			if ( strcasecmp( rd.llevel[rd.level].name, "vertices" ) == 0 )
            {
