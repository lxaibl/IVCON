...
// Purpose:
//   Methods for support of AutoCAD 3D Studio Max binary files
...
int tds_write_limited_string ( FileIO *fileout, const char *string, int maxlen )
...
int tds_write_string ( FileIO *fileout, const char *string )
